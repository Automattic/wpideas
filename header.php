...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'wpideas' ), max( $paged, $page ) );
...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			...
			<nav id="access" role="navigation">
				<h3 class="assistive-text"><?php _e( 'Main menu', 'wpideas' ); ?></h3>
				<?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff. */ ?>
				<div class="skip-link"><a class="assistive-text" href="#content" title="<?php esc_attr_e( 'Skip to primary content', 'wpideas' ); ?>"><?php _e( 'Skip to primary content', 'wpideas' ); ?></a></div>
